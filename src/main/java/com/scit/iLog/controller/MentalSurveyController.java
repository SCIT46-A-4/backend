...
public class MentalSurveyController {
	...
	public String handleGetMentalSurveyDetailsView(
			...
			Model model) {
		MentalSurveyResponseDetailsDTO responseDetails = mentalSurveyService.getResponseDetailsById(childId,
				responseId);
	...
	public String handleGetMentalSurveySelects(
			@PathVariable("childId") Long childId,
			@AuthenticationPrincipal MemberDetails memberDetails, // 2025-03-13 / 김은진 추가
			Model model) {
	...
	public List<MentalSurveyResponseChartDTO> getMentalScores(
		...
		if (calendarNum <= 7)
			mentalSurveyResponseChartDTOList = mentalSurveyService.getLastWeekData(childId);
		else if (calendarNum <= 30)
			mentalSurveyResponseChartDTOList = mentalSurveyService.getLastMonthData(childId);
		else if (calendarNum <= 180)
			mentalSurveyResponseChartDTOList = mentalSurveyService.getLastYearData(childId);
