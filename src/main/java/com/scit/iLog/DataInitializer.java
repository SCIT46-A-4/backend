        ...
        public void run(String... args) throws Exception {
                ...
                for (FamilyBackGround familyBackGround : FamilyBackGround.values()) {
                        ...
                        for (int i = 1; i <= 10; i++) {
                                ...
                                String email = firstName.toLowerCase() + lastName.toLowerCase() + random.nextInt(100)
                                        + "@example.com";
                                ...
                                for (int j = 0; j < 2; j++) {
                                        ...
                                        String childName = "Baby " + firstNames[random.nextInt(firstNames.length)] + " "
                                        ...
                                        for (int k = 0; k < 40; k++) {
                                                ...
                                                AnalysisTargetEntity analysisTarget = AnalysisTargetEntity.builder()
                                                        ...
                                                        .originalTargetFileName(
                                                                "survey_orig_" + random.nextInt(1000) + ".jpg")
                                                        .savedTargetFileName(
                                                                "survey_saved_" + random.nextInt(1000) + ".jpg")
                                                ...
                                                WeatherEntity weather = WeatherEntity.builder()
                                                        ...
                                                        .weatherDesc("Weather: "
                                                                + (random.nextBoolean() ? "Clear" : "Cloudy"))
                                                        .build();
                                                ...
                                                AnalysisResultNoteEntity analysisResultNote = AnalysisResultNoteEntity.builder()
                                                        ...
                                                        .content("This is a note on the analysis result "
                                                                + random.nextInt(1000))
                                                        .build();
                                                AnalysisSatisfactionEntity analysisSatisfaction = AnalysisSatisfactionEntity
                                                        .builder()
                                        ...
                                        for (int k = 0; k < 40; k++) {
                                                ChildDiaryEntity diary = ChildDiaryEntity.builder()
                                                        .author(mom)
                                                        .child(girl)
                                                        .content("Today, " + girl.getName()
                                                                + " had a great day at preschool. "
                                                                + random.nextInt(100))
                                        ...
                                        for (int k = 0; k < 40; k++) {
                                                ...
                                                HealthCheckEntity healthCheck = HealthCheckEntity.builder()
                                                        ...
                                                        .member(mom)
                                                        .originalFileName(
                                                                "health_orig_" + random.nextInt(1000) + ".jpg")
